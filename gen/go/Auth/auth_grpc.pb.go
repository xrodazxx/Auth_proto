...
const (
	...
	Auth_ReqPasswordReset_FullMethodName = "/auth.Auth/ReqPasswordReset"
...
func (c *authClient) ReqPasswordReset(ctx context.Context, in *ReqPasswordResetRequest, opts ...grpc.CallOption) (*ReqPasswordResetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReqPasswordResetResponse)
	err := c.cc.Invoke(ctx, Auth_ReqPasswordReset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_ReqPasswordReset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqPasswordResetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).ReqPasswordReset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_ReqPasswordReset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).ReqPasswordReset(ctx, req.(*ReqPasswordResetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReqPasswordReset",
			Handler:    _Auth_ReqPasswordReset_Handler,
		},
		{
